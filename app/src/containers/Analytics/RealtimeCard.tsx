        ...
        <CardContent>
            <Box>
                ...
                <Box sx={styles.updateLiveRow}>
                    ...
                    <ColorText color="neutral.normal"><Typography>Updating Live</Typography></ColorText>
                </Box>
                <Divider sx={styles.divider} />
                <Typography sx={styles.valueText}>4,144</Typography>
                <ColorText color="neutral.normal"><Typography>Subscribers</Typography></ColorText>
                <Divider sx={styles.divider} />
                <Typography sx={styles.valueText}>1,786</Typography>
                <ColorText color="neutral.normal"><Typography>Views Last 48 hours</Typography></ColorText>
