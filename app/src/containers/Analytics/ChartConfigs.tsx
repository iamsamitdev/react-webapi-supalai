...
export const mainChartOptions: any = {
    responsive: true,
...
export const getMainChartData:any = () => {
    return {
        labels: days,
        datasets: [
            {
...
export const realtimeChartOptions: any = {
    labels: realtimeChartLabels,
    responsive: true,
    maintainAspectRatio: false,
    plugins: {
    ...
    scales: {
        ...
        x: {
            ...
            ticks: {
                callback: (_label: any, index: number) => (index === 0 || index === 47) ? realtimeChartLabels[index] : null,
                align: 'inner',
                autoSkip: false
            }
        }
